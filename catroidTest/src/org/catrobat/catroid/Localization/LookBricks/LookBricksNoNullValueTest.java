...
public class LookBricksNoNullValueTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private MainMenuActivity mActivity;
    private Sprite sprite1,sprite2;


    public LookBricksNoNullValueTest() {
    ...
    public void assertNotNullValueInRTLMode()
    {
        ...
        Espresso.onView(withText(R.string.brick_set_look)).check(matches(notNullValue()));

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_looks)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_next_look)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_next_look)).check(matches(notNullValue()));
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_size_by)).check(matches(notNullValue()));

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_looks)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_hide)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_hide)).check(matches(notNullValue()));
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_show)).check(matches(notNullValue()));
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_set_transparency)).check(matches(notNullValue()));
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_brightness)).check(matches(notNullValue()));
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_clear_graphic_effect)).check(matches(notNullValue()));
