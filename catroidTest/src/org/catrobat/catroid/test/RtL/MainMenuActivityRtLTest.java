 ...
 */
public class MainMenuActivityRtLTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
    private static final String TAG = MainMenuActivityRtLTest.class.getSimpleName();
    ...
    public MainMenuActivityRtLTest() {
    ...
    public void testRTL() {
        ...
        String programmButtonText = solo.getString(R.string.main_menu_programs);
        solo.clickOnButton(programmButtonText);
        solo.sleep(2000);
        ...
        String newButtonText = solo.getString(R.string.main_menu_new);
        solo.clickOnText(newButtonText);
        solo.goBackToActivity(MainMenuActivity.class.getSimpleName());
