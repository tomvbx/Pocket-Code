...
public class UserBricksTextDirectionTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private Sprite sprite1;
    Activity mActivity;

    public UserBricksTextDirectionTest() {
    ...
    public void assertTextDirectionIsRTL()
    {
        ...
        Espresso.onView(withId(R.id.brick_user_flow_layout)).check(isTextDirectionRTL());
