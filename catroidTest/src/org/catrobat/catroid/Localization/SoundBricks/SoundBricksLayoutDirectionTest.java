...
public class SoundBricksLayoutDirectionTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private MainMenuActivity mActivity;
    private Sprite sprite1,sprite2;


    public SoundBricksLayoutDirectionTest() {
    ...
    public void assertBricksIsDisplayedCorrectlyInRTLMode()
    {
        ...
        Espresso.onView(withText(R.string.brick_play_sound)).check(isLayoutDirectionRTL());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_sound)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_stop_all_sounds)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_stop_all_sounds)).check(isLayoutDirectionRTL());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_volume_by)).check(isLayoutDirectionRTL());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_sound)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_speak)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_speak)).check(isLayoutDirectionRTL());
