...
public class LookBricksTextDirectionTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private MainMenuActivity mActivity;
    private Sprite sprite1,sprite2;


    public LookBricksTextDirectionTest() {
    ...
    public void assertTextDirectionIsRTL()
    {
        ...
        Espresso.onView(withText(R.string.brick_set_look)).check(isTextDirectionRTL());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_looks)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_next_look)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_next_look)).check(isTextDirectionRTL());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_size_by)).check(isTextDirectionRTL());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_looks)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_hide)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_hide)).check(isTextDirectionRTL());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_show)).check(isTextDirectionRTL());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_set_transparency)).check(isTextDirectionRTL());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_brightness)).check(isTextDirectionRTL());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_clear_graphic_effect)).check(isTextDirectionRTL());
