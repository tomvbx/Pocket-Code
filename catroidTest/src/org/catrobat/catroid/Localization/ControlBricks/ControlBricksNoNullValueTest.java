...
public class ControlBricksNoNullValueTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private MainMenuActivity mActivity;
    private Sprite sprite1,sprite2;


    public ControlBricksNoNullValueTest() {
    ...
    public void assertNotNullValueInRTLMode()
    {
        ...
        Espresso.onView(withText(R.string.brick_broadcast)).check(matches(notNullValue()));

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_control)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_broadcast_receive)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_broadcast_receive)).check(matches(notNullValue()));

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_control)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_when)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_when)).check(matches(notNullValue()));

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_control)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_wait)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_wait)).check(matches(notNullValue()));
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_note)).check(matches(notNullValue()));
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_repeat)).check(matches(notNullValue()));
    }
