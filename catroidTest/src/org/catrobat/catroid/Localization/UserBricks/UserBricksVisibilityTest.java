...
public class UserBricksVisibilityTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private Sprite sprite1;
    Activity mActivity;

    public UserBricksVisibilityTest() {
    ...
    public void assertIsVisibleBrickInRTL()
    {
        ...
        Espresso.onView(withId(R.id.brick_user_flow_layout)).check(isVisible());
