...
public class UserBricksLayoutDirectionTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private Sprite sprite1;
    Activity mActivity;

    public UserBricksLayoutDirectionTest() {
    ...
    public void assertLayoutDirectionIsRTL()
    {
        ...
        Espresso.onView(withId(R.id.brick_user_flow_layout)).check(isLayoutDirectionRTL());
