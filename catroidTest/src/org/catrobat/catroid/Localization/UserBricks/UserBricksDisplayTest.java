...
public class UserBricksDisplayTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private Sprite sprite1;
    Activity mActivity;

    public UserBricksDisplayTest() {
    ...
    public void assertBricksIsDisplayedCorrectlyInRTLMode()
    {
        ...
        Espresso.onView(withId(R.id.brick_user_flow_layout)).check(matches(isDisplayed()));
