...
public class DataBricksOverlappingTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {
    ...
    public DataBricksOverlappingTest() {
    ...
    public void assertNoOverLappingBricksInRTLMode()
    {
        ...
        Espresso.onView(withText(R.string.brick_set_variable)).check(noOverlaps());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_variable)).check(noOverlaps());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_show_text_var)).check(noOverlaps());
        ...
        Espresso.onView(withText(R.string.brick_add_item_to_userlist_add)).check(noOverlaps());
        Espresso.onView(withText(R.string.brick_delete_item_from_userlist_delete)).check(noOverlaps());
        Espresso.onView(withText(R.string.brick_insert_item_into_userlist_insert_into)).check(noOverlaps());
        Espresso.onView(withText(R.string.brick_replace_item_in_userlist_replace_in_list)).check(noOverlaps());
