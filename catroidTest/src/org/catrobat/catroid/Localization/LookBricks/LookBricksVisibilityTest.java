...
public class LookBricksVisibilityTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private MainMenuActivity mActivity;
    private Sprite sprite1,sprite2;


    public LookBricksVisibilityTest() {
    ...
    public void assertIsVisibleBrickInRTL()
    {
        ...
        Espresso.onView(withText(R.string.brick_set_look)).check(isVisible());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_looks)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_next_look)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_next_look)).check(isVisible());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_size_by)).check(isVisible());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_looks)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_hide)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_hide)).check(isVisible());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_show)).check(isVisible());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_set_transparency)).check(isVisible());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_brightness)).check(isVisible());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_clear_graphic_effect)).check(isVisible());
