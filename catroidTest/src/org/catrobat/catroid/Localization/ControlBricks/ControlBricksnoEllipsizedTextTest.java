...
public class ControlBricksnoEllipsizedTextTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private MainMenuActivity mActivity;
    private Sprite sprite1,sprite2;


    public ControlBricksnoEllipsizedTextTest() {
    ...
    public void assertNoEllipsizedTextInRTLMode()
    {
        ...
        Espresso.onView(withText(R.string.brick_broadcast_receive)).check(noEllipsizedText());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_control)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_when)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_when)).check(noEllipsizedText());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_control)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_broadcast)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_broadcast)).check(noEllipsizedText());

        Espresso.onView(withId(R.id.button_add)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.category_control)).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_wait)).perform(ViewActions.click());
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_wait)).check(noEllipsizedText());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_note)).check(noEllipsizedText());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_repeat)).check(noEllipsizedText());
