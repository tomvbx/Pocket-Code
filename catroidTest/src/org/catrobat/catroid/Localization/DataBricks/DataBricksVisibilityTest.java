...
public class DataBricksVisibilityTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {
    ...
    public DataBricksVisibilityTest() {
    ...
    public void assertIsVisibleBrickInRTL()
    {
        ...
        Espresso.onView(withText(R.string.brick_set_variable)).check(isVisible());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_change_variable)).check(isVisible());
        ...
        Espresso.onView(isRoot()).perform(ViewActions.click());
        Espresso.onView(withText(R.string.brick_show_text_var)).check(isVisible());
        ...
        Espresso.onView(withText(R.string.brick_add_item_to_userlist_add)).check(isVisible());
        Espresso.onView(withText(R.string.brick_delete_item_from_userlist_delete)).check(isVisible());
        Espresso.onView(withText(R.string.brick_insert_item_into_userlist_insert_into)).check(isVisible());
        Espresso.onView(withText(R.string.brick_replace_item_in_userlist_replace_in_list)).check(isVisible());
