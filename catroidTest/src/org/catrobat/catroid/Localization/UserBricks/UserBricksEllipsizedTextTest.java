...
public class UserBricksEllipsizedTextTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private Sprite sprite1;
    Activity mActivity;

    public UserBricksEllipsizedTextTest() {
    ...
    public void assertNoEllipsizedTextInRTLMode()
    {
        ...
        Espresso.onView(withId(R.id.brick_user_flow_layout)).check(noEllipsizedText());
