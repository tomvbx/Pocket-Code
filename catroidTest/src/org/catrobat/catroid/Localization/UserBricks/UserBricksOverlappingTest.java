...
public class UserBricksOverlappingTest extends ActivityInstrumentationTestCase2<MainMenuActivity> {

    private Sprite sprite1;
    Activity mActivity;

    public UserBricksOverlappingTest() {
    ...
    public void assertNoOverLappingBricksInRTLMode()
    {
        ...
        Espresso.onView(withId(R.id.brick_user_flow_layout)).check(noOverlaps());
